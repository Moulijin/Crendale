...
Public Const TitleString = "Crendale"
Public Const TheWebSite = "http://www.Crendale.com/"
...
Sub CreateClassData()
    ...
    With Class(5)    'Barbarian
        ...
        .StartMana = 20
    End With
    With Class(6)    'Sorcerer
        .name = "Sorcerer"
        .StartHP = 70
        .StartEnergy = 20
        .StartMana = 20
    End With
    With Class(7)    'Assassin
        .name = "Assassin"
        .StartHP = 70
        .StartEnergy = 20
        .StartMana = 20
...
Function SwearFilter(ByVal St As String) As Boolean
    ...
    If A > 0 Then SwearFilter = True
    A = InStr(UCase$(StrippedString), "Ancient")
    If A > 0 Then SwearFilter = True
    A = InStr(UCase$(StrippedString), "SLUT")
    If A > 0 Then SwearFilter = True
    A = InStr(UCase$(St), "               ")
