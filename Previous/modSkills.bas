...
Sub ProcessSkillLevelUp(St As String)
    ...
    Case 4    'Exploring
        PrintChat "Your exploring skill has increased to level " + CStr(Character.Skill(4).Level) + "!", 12
    Case 5    'Enchanting
...
Sub DrawSkillsList()
    ...
    For A = 1 To MaxSkill
        If A > 4 And Character.Access = 0 Then DontDraw = True Else DontDraw = False
        ...
        Case 4    'Exploring
            St = "Exploring - Level " + CStr(Character.Skill(4).Level)
