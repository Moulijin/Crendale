...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox picHelp 
      ...
      Begin VB.Label lblInstructions 
         Alignment       =   2  'Center
         BackColor       =   &H0044342E&
         Caption         =   "Welcome to the World of Crendale Online!  This is a basic guide to the game."
         BeginProperty Font 
            Name            =   "Times New Roman"
            Size            =   9.75
            Charset         =   0
                    ...
                    Case "BROADCAST", "BROADCAS", "BROADCA", "BROADC", "BROAD", "BROA", "BRO", "BR", "B"
                        If Suffix <> "" Then
                            If SwearFilter(Suffix) = True Then
                                PrintChat "Vulgar language is not allowed on Crendale.", YELLOW
                                ChatString = vbNullString
                                Exit Sub
                            End If
...
Private Sub lblMenu_MouseUp(index As Integer, Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Case 58    'Map Properties
        ...
        With EditMap
            frmMapProperties.Caption = "Crendale [Map " + CStr(CMap) + " Properties]"
...
Private Sub picList_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If ListIndex > 0 And ListIndex < 13 Then
        ...
        Case "Skills"
            ...
            Case 4    'Exploring
                    lblCurObj.Caption = "Exploring"
                    SetObjectInfo "Level " & Character.Skill(4).Level & vbCrLf & "Explore the World" & vbCrLf & "Press Esc + F1-F10 to hotkey this Skill"
            Case 5    'Enchanting
                If Character.Access > 0 Then
