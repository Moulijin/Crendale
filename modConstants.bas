...
'Game Control Contstants (was 3200
Public Const TargetMoveTicks = 3800 '(must be adjusted if default s are adjusted)

'8/16/32
Public Const MonsterWalkSpeed = 14
Public Const MonsterRunSpeed = 28
Public Const ProjectileSpeed = 35
