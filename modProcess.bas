...
Sub ProcessString(PacketID As Long, St As String)
        ...
        If Len(St) >= 1 Then
            ...
            Case 3    'Banned
                If Len(St) >= 5 Then
                    ...
                    If Len(St) > 5 Then
                        MsgBox "You are banned from Crendale until " + CStr(CDate(A)) + " (" + Mid$(St, 6) + ")!", vbOKOnly, TitleString
                    Else
                        MsgBox "You are banned from Crendale until " + CStr(CDate(A)) + "!", vbOKOnly, TitleString
                    End If
                    CloseClientSocket 3
                End If
            Case 4    'Server Full
    ...
    Case 12    'You joined map
        If Len(St) = 13 Then
            ...
            If CMap = 0 Then
                ...
                If B > 0 Then
                    St1 = Mid$(St1, 2)
                    PrintChat "Welcome to the Crendale!  There are " + CStr(B) + " other players online:" + St1, 15
                Else
                    PrintChat "Welcome to the Crendale!  There are no other users currently online.", 15
                End If
                LoadOptions
    ...
    Case 16    'Error messages
        If Len(St) >= 1 Then
            ...
            Case 42    'New Day
                PrintChat "A new day dawns in the land of Crendale!", 7
    ...
    Case 31    'Object Data
        If Len(St) >= 10 Then
            ...
            If A >= 1 Then
                ...
                SaveObject CInt(A)
                If frmList.Visible = True And ListEditMode = modeObjects Then
                    frmList.refreshList.Enabled = True
                End If
            End If
        End If
    ...
    Case 32    'Monster Data
        If Len(St) >= 8 Then
            ...
            If A >= 1 Then
                ...
                SaveMonster A
                If frmList.Visible = True And ListEditMode = modeMonsters Then
                    frmList.refreshList.Enabled = True
                End If
            End If
        End If
    ...
    Case 67    'Booted
        If Len(St) >= 1 Then
            ...
            If A >= 1 Then
                If Len(St) > 1 Then
                    MsgBox "You have been booted from Crendale by " + Player(A).name + ": " + Mid$(St, 2), vbOKOnly + vbExclamation, TitleString
                Else
                    MsgBox "You have been booted from Crendale by " + Player(A).name + "!", vbOKOnly + vbExclamation, TitleString
                End If
            Else
                If Len(St) > 1 Then
                    MsgBox "You have been booted from Crendale: " + Mid$(St, 2), vbOKOnly + vbExclamation, TitleString
                Else
                    MsgBox "You have been booted from Crendale!", vbOKOnly + vbExclamation, TitleString
                End If
            End If
            CloseClientSocket 0
        End If
        ...
        If Len(St) >= 1 Then
            ...
            If A >= 1 Then
                With NPC(A)
                    ...
                    SaveNPC CInt(A)
                    If frmList.Visible = True And ListEditMode = modeNPCs Then
                        frmList.refreshList.Enabled = True
                    End If
                End With
            End If
    ...
    Case 117    'Float Code
        ...
        Select Case C
        Case 1    'Miss
            CreateFloatText "Missed!", 14, CByte(A), CByte(B)
        Case 2    'Dead
            CreateFloatText "Killed!", 12, CByte(A), CByte(B)
        Case 3    'Caught something
            D = Asc(Mid$(St, 4, 1))
            CreateFloatText "$$$", 11, CByte(A), CByte(B)
    ...
    Case 122    'Object List
        St1 = ""
        frmWait.lblStatus = "Updating Crendale Objects ..."
        frmWait.Refresh
    ...
    Case 123    'NPC List
        St1 = ""
        frmWait.lblStatus = "Updating Crendale NPCs ..."
        frmWait.Refresh
        For A = 1 To MaxNPCs
            LoadNPC CInt(A)
    ...
    Case 124    'Hall List
        St1 = ""
        frmWait.lblStatus = "Updating Crendale Halls ..."
        frmWait.Refresh
        For A = 1 To MaxHalls
            LoadHall CInt(A)
    ...
    Case 125    'Monster List
        St1 = ""
        frmWait.lblStatus = "Updating Crendale Monsters ..."
        frmWait.Refresh
    ...
    Case 126    'Magic List
        St1 = ""
        frmWait.lblStatus = "Updating Crendale Magic ..."
        frmWait.Refresh
        For A = 1 To MaxMagic
            LoadMagic CInt(A)
    ...
    Case 127    'Magic Data
        If Len(St) >= 3 Then
            ...
            If A >= 1 Then
                ...
                SaveMagic CInt(A)
                If frmList.Visible = True And ListEditMode = modeMagic Then
                    frmList.refreshList.Enabled = True
                End If
            End If
        End If
    ...
    Case 131    'Prefix List
        St1 = ""
        frmWait.lblStatus = "Updating Crendale Prefixes ..."
        frmWait.Refresh
    ...
    Case 132    'Suffix List
        St1 = ""
        frmWait.lblStatus = "Updating Crendale Suffixes ..."
        frmWait.Refresh
        For A = 1 To MaxModifications
            LoadSuffix CInt(A)
    ...
    Case 133    'Prefix
        ...
        With ItemPrefix(A)
            ...
            SavePrefix (CByte(A))
            If frmList.Visible = True And ListEditMode = modePrefix Then
                frmList.refreshList.Enabled = True
            End If
        End With
    Case 134    'Suffix
        ...
        With ItemSuffix(A)
            ...
            SaveSuffix (CByte(A))
            If frmList.Visible = True And ListEditMode = modeSuffix Then
                frmList.refreshList.Enabled = True
            End If
        End With
